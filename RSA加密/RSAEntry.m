...
//  MyAlertPay
//
//  Created by fengei on 16/7/7.
//  Copyright © 2016年 fengei. All rights reserved.
//

#import "RSAEntry.h"

@implementation RSAEntry
...
+ (NSString *)encryptData:(NSData *)data withKeyRef:(SecKeyRef) keyRef{
...
//                               &outlen
//                               );
//        NSLog(@"%ld/%d block_size: %d", outlen, (int)srclen, (int)block_size);
//        if (status != 0) {
...
//    return ret;
    ...
    do {
        ...
        if(status == noErr)
        {
            NSData *tempData = [NSData dataWithBytes:outbuf length:outlen];
            NSString *tempString = base64_encode_data(tempData);
